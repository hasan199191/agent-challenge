...
**Twitter:** https://x.com/chefcryptoz/status/1941492768691322881

**Discord:** https://discord.com/channels/236263424676331521/1047850933821911040/1391051927470608384

**Solana address:** CCCsN6jUDtMHFvCjrZirGePrHwaXRQ4n1D2vbAppGwc9

**Host address:** 9TSWmDKabkULeSdVLD99HoNeafD7sNb2sbr4MkRFQkuhLQTbuitFTxLZk

**Deployer address:** 67YTahkcKxFwMsnCjPatBT3SgTFQkuhLQTbuitFTxLZk

**Nosana Deployment Proof:** https://4sjyd3jvcvj38toxjgkif7vkbw96yect2mcghpdkzpxd.node.k8s.prd.nos.ci/agents/healthAgent/chat
...
```env
# Local Ollama Configuration (PRIMARY - recommended for development)
API_BASE_URL=http://127.0.0.1:11434/api
MODEL_NAME_AT_ENDPOINT=qwen2.5:1.5b

# Nosana Fallback Endpoint (SECONDARY - used if local Ollama fails)
# API_BASE_URL=https://4qvrhtl5tvy69ca2veau9dxhpt43lbpofdjbu6r21wvv.node.k8s.prd.nos.ci/api

# Docker Configuration (for containerized deployment)
# API_BASE_URL=http://0.0.0.0:11434/api

# Advanced Configuration (for larger models)
# API_BASE_URL=https://your-nosana-endpoint.node.k8s.prd.nos.ci/api
...
Topic
Nosana Builders Challenge, 2nd edition Agent-101: Build your first agent
